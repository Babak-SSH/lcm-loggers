...
int example_t::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __int64_t_encode_array(buf, offset + pos, maxlen - pos, &this->counter, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int example_t::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __int64_t_decode_array(buf, offset + pos, maxlen - pos, &this->counter, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
{
    uint64_t hash = 0x304d5fa4873b382cLL;
